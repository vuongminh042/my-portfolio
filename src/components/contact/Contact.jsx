...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs
            .sendForm('service_0m8ht87', 'template_6rbycpc', formRef.current, '4vVc0TR_e_xXTYGLG')
            .then(
                (result) => {
                    setSuccess(true);
                },
    ...
    return (
        <motion.div className="contact" variants={variant} initial="initial" whileInView="animate">
            <motion.div className="textContainer" variants={variant}>
                <motion.h1 variants={variant}>Lets work together</motion.h1>
                <motion.div className="item" variants={variant}>
                    <h2>Mail</h2>
                    <span>vuongchiminh320@gmail.com</span>
                </motion.div>
                <motion.div className="item" variants={variant}>
                    <h2>Address</h2>
                    <span>Phuc Tho - Ha Noi</span>
                </motion.div>
                <motion.div className="item" variants={variant}>
                    <h2>Phone</h2>
                    <span>+84 37 325 6336</span>
                </motion.div>
            </motion.div>
            ...
            C32.666,7.326,25.339,0,16.333,0z"
                ...
                >
                    ...
                    {error && <div className="error">Error: Message not sent</div>}
